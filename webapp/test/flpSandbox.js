		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Digital Store",
									"targetURL": "#comincturedigitalstore-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comincturedigitalstore-display": {
								"semanticObject": "comincturedigitalstore",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.incture.digitalstore",
									"url": sap.ui.require.toUrl("com/incture/digitalstore")
								}
							}
						}
					}
